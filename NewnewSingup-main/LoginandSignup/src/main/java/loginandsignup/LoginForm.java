...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void jbtnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCancelActionPerformed
       int result = JOptionPane.showConfirmDialog(this, "Do you want to continue or leave?", "Confirmation", JOptionPane.YES_NO_OPTION);
    ...
    if (username.isEmpty() || password.isEmpty()) {
        ...
        if (isValidLogin(username, password)) {
            ...
            // Invalid login
            JOptionPane.showMessageDialog(this, "Invalid username/password not found", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private boolean isValidLogin(String enteredUsername, String enteredPassword) {
        ...
        e.printStackTrace();
        System.err.println("Error: File 'user.txt' not found.");
    } catch (IOException e) {
        e.printStackTrace();
        System.err.println("Error reading from file 'user.txt'.");
    }
